...
function App() {
    const projects = [
	{name: Budgetbook, description: "BudgetBook is a react app designed for managing expenses. Users are able to manage a list of expenses by the way of add and delete buttons. They are also able to modify the budget for the expense list in order to keep track of how much budget is remaining in relation to how much the total expenses in the expenses list total up to.", link: "https://budget-book.vercel.app"
